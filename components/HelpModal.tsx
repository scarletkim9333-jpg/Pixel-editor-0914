    ...
    <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-[#FDF6E3] border-2 border-black shadow-[4px_4px_0_0_#000] p-6 w-full max-w-2xl flex flex-col gap-4 max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
        <div className="flex justify-between items-center">
            <h2 className="text-xl font-bold text-black font-neodgm">{t.helpTitle}</h2>
            <button 
              onClick={onClose}
        ...
        <div className="text-base text-gray-800 space-y-6 overflow-y-auto pr-2">
            <div>
                <h3 className="text-lg font-semibold text-[#2E7D73] mb-2 font-neodgm">{t.helpApiTitle}</h3>
                <p className="text-black">{t.helpApiStep1}</p>
            </div>
            
            <div>
                <h3 className="text-lg font-semibold text-[#2E7D73] mb-2 font-neodgm">{t.helpUsageTitle}</h3>
                <p className="mb-3">{t.helpUsageDesc1}</p>
                <div className="space-y-4">
                    <div className="bg-black/5 p-3 border border-black">
                        <p className="font-semibold text-black font-neodgm">{t.helpUsageBasicTitle}</p>
                        <p className="text-sm text-gray-700">{t.helpUsageBasicDesc}</p>
                    </div>
                     <div className="bg-black/5 p-3 border border-black">
                        <p className="font-semibold text-black font-neodgm">{t.helpUsagePresetsTitle}</p>
                     ...
                     <div className="bg-black/5 p-3 border border-black">
                        <p className="font-semibold text-black font-neodgm">{t.helpUsageMultiImageTitle}</p>
            ...
            <div>
                <h3 className="text-lg font-semibold text-[#2E7D73] mb-2 font-neodgm">{t.helpFeaturesTitle}</h3>
